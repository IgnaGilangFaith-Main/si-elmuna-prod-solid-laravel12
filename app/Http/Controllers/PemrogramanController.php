...
class PemrogramanController extends Controller
{
     ...
     */
    public function store(TambahPemrogramanRequest $request)
    {
    ...
    public function index(Request $request)
    {
        ...
        if (! empty($cari)) {
            ...
            $data = Pemrograman::latest()->paginate(25);
        }
     ...
     */
    public function update($id, EditPemrogramanRequest $request)
    {
        $validated = $request->validated();
        ...
        $pemrograman = Pemrograman::findOrFail($id);
        $pemrograman->update($validated);
     ...
     */
    public function deletedPemrograman()
    {
    ...
    {
        Pemrograman::withTrashed()->where('id', $id)->restore();
    ...
    {
        $data = Pemrograman::withTrashed()->findOrFail($id);
    ...
    {
        Pemrograman::withTrashed()->findOrFail($id)->forceDelete();
    ...
    public function export(Request $request)
    {
        ...
        $baseQuery = Pemrograman::orderBy('id', 'desc')
            ->whereDate('created_at', '>=', $start_date)
            ->whereDate('created_at', '<=', $end_date);
        ...
        $no = 1;
        $rows = 2;
        $filename = 'Laporan Daftar Peserta Pemrograman '.$start_date.' sampai '.$end_date.'.xlsx';
