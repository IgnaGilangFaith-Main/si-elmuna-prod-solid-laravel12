...
@section('content')
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-3 mb-3" data-aos="flip-left">
            <div class="card shadow">
                <img src="{{ asset('asset/img/public-speaking.jpg') }}" class="card-img-top post-img" alt="publicspeaking">
                <div class="card-body">
                    <div class="card-text">
                        <center>
                            ...
                            <a href="{{ url('/daftar_public_speaking') }}" class="btn btn-primary mt-2">
                                Daftar Sekarang
                            </a>
                        </center>
                    </div>
