...
@section('title', 'Elmuna - Hapus Komputer')
@section('content')
    <center>
        <h2>Hapus Data Peserta Komputer</h2>
    </center>
    <div class="my-3">
        <center>
            ...
            <h4>
                ...
                <div class="mt-3">
                    <form action="{{ url('/force-delete-komputer/' . $data->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="{{ url('/data_komputer/terhapus') }}" class="btn btn-secondary mx-3">Kembali</a>
