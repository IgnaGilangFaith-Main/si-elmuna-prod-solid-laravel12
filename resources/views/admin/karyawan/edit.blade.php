    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('/edit-karyawan/' . $data->id) }}" method="post" enctype="multipart/form-data">
                ...
                @isset($data->foto_karyawan)
                    <img src="{{ asset('foto_karyawan' . '/' . $data->foto_karyawan) }}" alt="foto_karyawan {{ $data->nama }}"
                        class="img-thumbnail" width="20%">
                @endisset
                <div class="mb-3">
                    <label for="foto_karyawan" class="form-label">Foto Karyawan</label>
                    <input type="file" name="foto_karyawan" id="foto_karyawan" class="form-control"
