...
@section('title', 'Elmuna - Hapus Digital Marketing')
@section('content')
    <center>
        <h2>Hapus Data Peserta Digital Marketing</h2>
    </center>
    <div class="my-3">
        <center>
            ...
            <h4>
                ...
                <div class="mt-3">
                    <form action="{{ url('/force-delete-digital_marketing/' . $data->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="{{ url('/data_digital_marketing/terhapus') }}" class="btn btn-secondary mx-3">Kembali</a>
