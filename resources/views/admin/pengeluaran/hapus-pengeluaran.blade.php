...
@section('title', 'Hapus Data Pengeluaran')
@section('content')
    <center>
    ...
    <div class="my-3">
        <center>
            ...
            <h4>
                ...
                <div class="mt-3">
                    <form action="{{ url('/destroy-pengeluaran/' . $data->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="{{ url('/pengeluaran') }}" class="btn btn-secondary mx-3">Kembali</a>
