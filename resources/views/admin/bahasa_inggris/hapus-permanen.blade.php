...
@section('title', 'Elmuna - Hapus Bahasa Inggris')
@section('content')
    <center>
        <h2>Hapus Data Peserta Bahasa Inggris</h2>
    </center>
    <div class="my-3">
        <center>
            ...
            <h4>
                ...
                <div class="mt-3">
                    <form action="{{ url('/force-delete-bahasa_inggris/' . $data->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="{{ url('/data_bahasa_inggris/terhapus') }}" class="btn btn-secondary mx-3">Kembali</a>
