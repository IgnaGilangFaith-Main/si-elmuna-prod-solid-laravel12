...
@section('title', 'Elmuna - Hapus Desain Grafis')
@section('content')
    <center>
        <h2>Hapus Data Peserta Desain Grafis</h2>
    </center>
    <div class="my-3">
        <center>
            ...
            <h4>
                ...
                <div class="mt-3">
                    <form action="{{ url('/destroy-desain_grafis/' . $data->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="{{ url('/data_desain_grafis') }}" class="btn btn-secondary mx-3">Kembali</a>
