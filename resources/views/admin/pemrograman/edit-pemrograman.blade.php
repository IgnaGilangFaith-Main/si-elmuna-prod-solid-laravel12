...
@section('title', 'Elmuna - Edit Pemrograman')
@section('content')
    <div class="card">
        <div class="card-header">
            <center>
                <h3>Form Edit Peserta Kursus Pemrograman</h3>
            </center>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            @endphp
            <form action="{{ url('/update-pemrograman/' . $data->id) }}" method="post">
                @csrf
                @method('put')
                <center>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="pemrograman_web_dasar" class="form-check-input"
                            ...
                            {{ in_array('PEMROGRAMAN WEB DASAR', $paket) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="pemrograman_web_laravel" class="form-check-input"
                            ...
                            {{ in_array('PEMROGRAMAN WEB LARAVEL', $paket) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="javascript_dasar" class="form-check-input"
                            value="JAVASCRIPT DASAR" {{ in_array('JAVASCRIPT DASAR', $paket) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="javascript_lanjutan" class="form-check-input"
                            value="JAVASCRIPT LANJUTAN" {{ in_array('JAVASCRIPT LANJUTAN', $paket) ? 'checked' : '' }}>
                ...
                <div class="my-2">
                    <center>
                        <a href="{{ url('/data_pemrograman') }}" class="btn btn-secondary">Kembali</a>
