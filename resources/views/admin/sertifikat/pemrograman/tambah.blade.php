...
@section('title', 'Tambah Sertifikat Pemrograman')
@push('css')
    <style>
...
@endpush
@section('content')
    <form action="{{ url('/tambah-sertifikat/pemrograman') }}" method="post">
        @csrf
        @if ($errors->any())
            ...
            <div class="row">
                <div class="col-md-12 my-0">
                    <center>
                        ...
                        <div class="telah">
                            <p>Telah Menyelesaikan Pendidikan Pemrograman Program <input type="text" name="program"
