...
@section('title', 'Edit Sertifikat Video Editing & Fotografi')
@push('css')
    <style>
...
@endpush
@section('content')
    <form action="{{ url('/edit-sertifikat/video-editing-fotografi/' . $data->id) }}" method="post">
        @method('put')
        @csrf
        @if ($errors->any())
