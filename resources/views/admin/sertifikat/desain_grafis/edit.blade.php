...
@section('title', 'Edit Sertifikat Desain Grafis')
@push('css')
    <style>
...
@endpush
@section('content')
    <form action="{{ url('/edit-sertifikat/desain-grafis/' . $data->id) }}" method="post">
        @method('put')
        @csrf
        @if ($errors->any())
            ...
            <div class="row">
                <div class="col-md-12 my-0">
                    <center>
                        ...
                        <div class="telah">
                            <p>Telah Menyelesaikan Pendidikan Desain Grafis Program <input type="text" name="program"
        ...
        <div class="my-2">
            <center>
                <a href="{{ url('/sertifikat/desain-grafis') }}" class="btn btn-secondary">Kembali</a>
