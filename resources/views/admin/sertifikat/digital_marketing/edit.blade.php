...
@section('title', 'Edit Sertifikat Digital Marketing')
@push('css')
    <style>
...
@endpush
@section('content')
    <form action="{{ url('/edit-sertifikat/digital-marketing/' . $data->id) }}" method="post">
        @method('put')
        @csrf
        @if ($errors->any())
            ...
            <div class="row">
                <div class="col-md-12 my-0">
                    <center>
                        ...
                        <div class="telah">
                            <p>Telah Menyelesaikan Pendidikan Digital Marketing Program <input type="text" name="program"
