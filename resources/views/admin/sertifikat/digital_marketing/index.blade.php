...
@section('title', 'Data Sertifikat Digital Marketing')
@section('content')
    <center>
        <h1 class="my-3">Sertifikat Digital Marketing</h1>
    </center>
    <div class="col-12 col-sm-8 col-md-4">
        <label for="" class="mb-2">Cari Data</label>
        <form action="{{ url('/sertifikat/digital-marketing') }}" method="get">
            <div class="input-group">
                ...
                <a href="{{ url('/sertifikat/digital-marketing') }}" class="btn btn-danger">Batal</a>
            </div>
        </form>
    </div>
    <hr>
                ...
                @if (count($data) > 0)
                    @foreach ($data as $datum)
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="{{ url('/sertifikat/digital-marketing/edit/' . $datum->id) }}"
                                        class="btn btn-warning">Edit</a>
                                    <a href="{{ url('/sertifikat/digital-marketing/cetak/' . $datum->id . '/sertifikat') }}"
                                        target="_blank" class="btn btn-success my-2">Print Sertifikat PDF</a>
                                    <a href="{{ url('/sertifikat/digital-marketing/cetak/' . $datum->id . '/print-depan') }}"
                                        target="_blank" class="btn btn-success mb-2">
                                        Print Sertifikat
                                    </a>
                                    <a href="{{ url('/sertifikat/digital-marketing/cetak/' . $datum->id . '/nilai') }}"
                                        target="_blank" class="btn btn-success">Print Nilai</a>
                                    <a href="{{ url('/sertifikat/digital-marketing/hapus/' . $datum->id) }}"
