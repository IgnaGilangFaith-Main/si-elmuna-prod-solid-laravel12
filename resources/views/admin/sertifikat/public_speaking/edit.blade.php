...
@section('title', 'Edit Sertifikat Bahasa Inggris')
@push('css')
    <style>
...
@endpush
@section('content')
    <form action="{{ url('/edit-sertifikat/public-speaking/' . $data->id) }}" method="post">
        @method('put')
        @csrf
        @if ($errors->any())
            ...
            <div class="row">
                <div class="col-md-12 my-0">
                    <center>
                        ...
                        <div class="telah">
                            <p>Telah Menyelesaikan Pendidikan Bahasa Inggris Program <input type="text" name="program"
        ...
        <div class="my-2">
            <center>
                <a href="{{ url('/sertifikat/public-speaking') }}" class="btn btn-secondary">Kembali</a>
