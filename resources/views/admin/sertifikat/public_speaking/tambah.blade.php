...
@section('title', 'Tambah Sertifikat Public Speaking')
@push('css')
    <style>
...
@endpush
@section('content')
    <form action="{{ url('/tambah-sertifikat/public-speaking') }}" method="post">
        @csrf
        @if ($errors->any())
            ...
            <div class="row">
                <div class="col-md-12 my-0">
                    <center>
                        ...
                        <div class="telah">
                            <p>Telah Menyelesaikan Pendidikan Public Speaking Program <input type="text" name="program"
        ...
        <div class="my-2">
            <center>
                <a href="{{ url('/data_public_speaking') }}" class="btn btn-secondary">Kembali</a>
