...
@section('title', 'Hapus Sertifikat Public Speaking')
@push('css')
    <style>
...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12 my-0">
                <center>
                    ...
                    <div class="telah">
                        <p>Telah Menyelesaikan Pendidikan Public Speaking Program {{ $data->program }}</p>
    ...
    <div class="my-2">
        <center>
            <form action="{{ url('/destroy-sertifikat/public-speaking/' . $data->id) }}" method="post">
                @method('DELETE')
                @csrf
