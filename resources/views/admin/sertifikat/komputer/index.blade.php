...
@section('title', 'Data Sertifikat Komputer')
@section('content')
    <center>
        <h1 class="my-3">Sertifikat Komputer</h1>
    </center>
    <div class="col-12 col-sm-8 col-md-4">
        <label for="" class="mb-2">Cari Data</label>
        <form action="{{ url('/sertifikat/komputer') }}" method="get">
            <div class="input-group">
                ...
                <a href="{{ url('/sertifikat/komputer') }}" class="btn btn-danger">Batal</a>
            </div>
        </form>
    </div>
    <hr>
                ...
                @if (count($data) > 0)
                    @foreach ($data as $datum)
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="{{ url('/sertifikat/komputer/edit/' . $datum->id) }}"
                                        class="btn btn-warning">Edit</a>
                                    <a href="{{ url('/sertifikat/komputer/cetak/' . $datum->id . '/sertifikat') }}"
                                        target="_blank" class="btn btn-success my-2">Print Sertifikat PDF</a>
                                    <a href="{{ url('/sertifikat/komputer/cetak/' . $datum->id . '/print-depan') }}"
                                        target="_blank" class="btn btn-success mb-2">
                                        Print Sertifikat
                                    </a>
                                    <a href="{{ url('/sertifikat/komputer/cetak/' . $datum->id . '/nilai') }}"
                                        target="_blank" class="btn btn-success">Print Nilai</a>
                                    <a href="{{ url('/sertifikat/komputer/hapus/' . $datum->id) }}"
