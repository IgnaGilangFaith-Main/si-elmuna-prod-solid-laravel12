...
@section('title', 'Tambah Sertifikat Komputer')
@push('css')
    <style>
...
@endpush
@section('content')
    <form action="{{ url('/tambah-sertifikat/komputer') }}" method="post">
        @csrf
        @if ($errors->any())
            ...
            <div class="row">
                <div class="col-md-12 my-0">
                    <center>
                        ...
                        <div class="telah">
                            <p>Telah Menyelesaikan Pendidikan Komputer Program <input type="text" name="program"
                        ...
                        <tr>
                            ...
                            <td class="signature" style="width: 50%">
                                <div class="tanda-tangan">
                                    <center>
                                        <p>
                                            Kebumen, {{ now()->isoFormat('DDD MMMM Y') }} <br />
                                            Bagian Akademik
                                        </p>
