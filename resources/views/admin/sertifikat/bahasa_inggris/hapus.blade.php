...
@section('title', 'Hapus Sertifikat Bahasa Inggris')
@push('css')
    <style>
...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12 my-0">
                <center>
                    ...
                    <div class="telah">
                        <p>Telah Menyelesaikan Pendidikan Bahasa Inggris Program {{ $data->program }}</p>
    ...
    <div class="my-2">
        <center>
            <form action="{{ url('/destroy-sertifikat/bahasa-inggris/' . $data->id) }}" method="post">
                @method('DELETE')
                @csrf
