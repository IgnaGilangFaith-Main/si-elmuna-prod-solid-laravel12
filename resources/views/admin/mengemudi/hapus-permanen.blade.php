...
@section('title', 'Elmuna - Hapus Mengemudi')
@section('content')
    <center>
        <h2>Hapus Data Peserta Mengemudi</h2>
    </center>
    <div class="my-3">
        <center>
            ...
            <h4>
                ...
                <div class="mt-3">
                    <form action="{{ url('/force-delete-mengemudi/' . $data->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="{{ url('/data_mengemudi/terhapus') }}" class="btn btn-secondary mx-3">Kembali</a>
