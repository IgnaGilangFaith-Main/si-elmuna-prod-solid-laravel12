...
@section('title', 'Elmuna - Edit Public Speaking')
@section('content')
    <div class="card">
        <div class="card-header">
            <center>
                <h3>Form Edit Peserta Kursus Public Speaking</h3>
            </center>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            @endphp
            <form action="{{ url('/update-public_speaking/' . $data->id) }}" method="post">
                @csrf
                @method('put')
                <center>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="reguler" class="form-check-input" value="REGULER"
                            {{ in_array('REGULER', $paket) ? 'checked' : '' }}>
