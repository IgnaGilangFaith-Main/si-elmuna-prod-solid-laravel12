...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('/tambah-komputer') }}" method="post">
                @csrf
                <center>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="paket_ms_office_lengkap" class="form-check-input"
                            ...
                            {{ in_array('PAKET MS. OFFICE LENGKAP', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="paket_ms_office_word" class="form-check-input"
                            ...
                            {{ in_array('PAKET MS. OFFICE WORD', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="paket_ms_office_excel" class="form-check-input"
                            ...
                            {{ in_array('PAKET MS. OFFICE EXCEL', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="paket_ms_office_power_point" class="form-check-input"
                            value="PAKET MS. OFFICE POWERPOINT"
                            {{ in_array('PAKET MS. OFFICE POWERPOINT', old('paket', [])) ? 'checked' : '' }}>
                        <label for="paket_ms_office_power_point" class="form-check-label">
                            PAKET MS. OFFICE POWERPOINT
                        </label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="paket_ms_office_power_point_spesial"
                            class="form-check-input" value="PAKET MS. OFFICE POWERPOINT SPESIAL"
                            {{ in_array('PAKET MS. OFFICE POWERPOINT SPESIAL', old('paket', [])) ? 'checked' : '' }}>
                        <label for="paket_ms_office_power_point_spesial" class="form-check-label">
                            PAKET MS. OFFICE POWERPOINT SPESIAL</label>
                    </div>
                    <div class="form-check">
