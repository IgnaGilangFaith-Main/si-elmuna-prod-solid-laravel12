@extends('layout.main')
@section('title', 'Elmuna - Daftar Public Speaking')
@section('content')
    <div class="card">
        <div class="card-header">
            <center>
                <h3>Form Pendaftaran Kursus Public Speaking</h3>
            </center>
        </div>
        <div class="card-body">
            <form action="{{ url('/tambah-public-speaking') }}" method="post">
                @csrf
                <center>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="reguler" class="form-check-input" value="REGULER"
                            {{ in_array('REGULER', old('paket', [])) ? 'checked' : '' }}>
