...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('/tambah-desain_grafis') }}" method="post">
                @csrf
                <center>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="desain_grafis_corel_draw" class="form-check-input"
                            ...
                            {{ in_array('DESAIN GRAFIS COREL DRAW', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="desain_grafis_adobe_photoshop"
                            ...
                            {{ in_array('DESAIN GRAFIS ADOBE PHOTOSHOP', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="desain_grafis_canva" class="form-check-input"
                            ...
                            {{ in_array('DESAIN GRAFIS CANVA', old('paket', [])) ? 'checked' : '' }}>
