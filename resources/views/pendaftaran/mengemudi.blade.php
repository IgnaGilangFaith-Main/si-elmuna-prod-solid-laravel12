...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('/tambah-mengemudi') }}" method="post">
                @csrf
                <center>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="paket_manual_1" class="form-check-input"
                            ...
                            {{ in_array('PAKET MANUAL 1 (MELANCARKAN)', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="paket_manual_2" class="form-check-input"
                            ...
                            {{ in_array('PAKET MANUAL 2 (PEMULA)', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="paket_manual_3" class="form-check-input"
                            ...
                            {{ in_array('PAKET MANUAL 3 (MAHIR)', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="paket_matic_1" class="form-check-input"
                            ...
                            {{ in_array('PAKET MATIC 1 (PEMULA)', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="paket_matic_2" class="form-check-input"
                            ...
                            {{ in_array('PAKET MATIC 2 (MAHIR)', old('paket', [])) ? 'checked' : '' }}>
