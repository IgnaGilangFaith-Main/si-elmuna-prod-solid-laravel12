...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('/tambah-bahasa_inggris') }}" method="post">
                @csrf
                <center>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="elmentary" class="form-check-input"
                            value="ELEMENTARY" {{ in_array('ELEMENTARY', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="intermediate" class="form-check-input"
                            value="INTERMEDIATE" {{ in_array('INTERMEDIATE', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="conversation" class="form-check-input"
                            value="CONVERSATION" {{ in_array('CONVERSATION', old('paket', [])) ? 'checked' : '' }}>
