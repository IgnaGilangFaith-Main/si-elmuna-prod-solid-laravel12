@extends('layout.main')
@section('title', 'Elmuna - Daftar Video Editing & Fotografi')
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <center>
                <h3>Form Pendaftaran Kursus Video Editing & Fotografi</h3>
            </center>
        </div>
        <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="video_editing_filmora" class="form-check-input"
                            ...
                            {{ in_array('VIDEO EDITING FILMORA', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="video_editing_capcut" class="form-check-input"
                            value="VIDEO EDITING CAPCUT"
                            {{ in_array('VIDEO EDITING CAPCUT', old('paket', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="paket[]" id="fotografi" class="form-check-input" value="FOTOGRAFI"
                            {{ in_array('FOTOGRAFI', old('paket', [])) ? 'checked' : '' }}>
